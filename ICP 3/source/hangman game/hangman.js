...
var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        this.hints      = {'PROGRAMMER': ['techie', 'hacker', 'engineer'], 'BRAINSTORM': ['analyse'], 'CREATIVE': ['intelligent'], 'LOLLIPOP': ['candy'], 'CULTURE': ['heritage'], 'RAZORSHARP': ['sharp'], 'SCREWDRIVER': ['handtool'], 'TYPEWRITER': ['typer']};
        this.hintimages = {'PROGRAMMER':'./programmer.jpeg', 'BRAINSTORM':'./brainstorm.jpg', 'CREATIVE':'./creative.jpg', 'LOLLIPOP':'./candy.png', 'CULTURE':'./culture.jpg', 'RAZORSHARP':'./razorsharp.jpg', 'SCREWDRIVER':'./screwdriver.jpg', 'TYPEWRITER':'./typewriter.png'};
    }
